...
public class BattleBoxCog4 : SpinnerControl {
   ...
   public static float moveToPosition2 = 0;
	...
	void Update () {
        ...
        {
            transform.position = Camera.main.ViewportToWorldPoint(new Vector3(1.145f, 0.06f, 1));
            inBattle2 = true;
        ...
        if (SpinnerControl.inBattle == false)
        {
            ...
            if (BattleTime.victoryAnimation == true && BattleTime.timer == 200)
            {
                transform.position = new Vector3(30.93f, -20.98f, 0);
            }
