...
public class BattleBoxCog2 : SpinnerControl {
   ...
   public static bool activateBattle2 = false;
	...
	void Update () {
        ...
        {
            transform.position = Camera.main.ViewportToWorldPoint(new Vector3(1.145f, 0.30f, 1));
            inBattle2 = true;
        ...
        if (SpinnerControl.inBattle == false)
        {
            ...
            if (BattleTime.victoryAnimation == true && BattleTime.timer == 200)
            {
                transform.position = new Vector3(25.38f, -20.98f, 0);
            }
