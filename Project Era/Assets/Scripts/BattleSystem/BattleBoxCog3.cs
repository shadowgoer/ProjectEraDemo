...
public class BattleBoxCog3 : SpinnerControl {
   public static bool activateBattle2 = false;
	...
	void Update () {
        ...
        {
            transform.position = Camera.main.ViewportToWorldPoint(new Vector3(1.145f, 0.18f, 1));
            inBattle2 = true;
        ...
        if (SpinnerControl.inBattle == false)
        {
            ...
            if (BattleTime.victoryAnimation == true && BattleTime.timer == 200)
            {
                transform.position = new Vector3(27.98f, -20.98f, 0);
            }
