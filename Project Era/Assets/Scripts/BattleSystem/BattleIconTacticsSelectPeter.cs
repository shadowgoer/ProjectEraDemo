...
public class BattleIconTacticsSelectPeter : MonoBehaviour {
	...
	void Update () {
        ...
        if (SpinnerControl.peterTurn == true)
        {
            ...
            if (buttonSelected == false)
            {
                ...
                if (BattleIconAttackSelectPeter.iconSelect == 1)
                {
            ...
            //Selecting Button
            if (BattleIconAttackSelectPeter.iconSelect == 1 && Input.GetKeyDown(KeyCode.A) && BattleIconAttackSelectPeter.hideButtons == false)
            {
