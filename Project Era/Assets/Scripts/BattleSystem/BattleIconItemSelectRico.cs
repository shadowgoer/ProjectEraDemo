...
public class BattleIconItemSelectRico : MonoBehaviour {
	...
	void Update () {
        ...
        else if (SpinnerControl.ricoTurn == true)
        {
            ...
            if (buttonSelected == false)
            {
                ...
                if (BattleIconAttackSelectRico.iconSelect == 2)
                {
            ...
            //Selecting Button
            if (BattleIconAttackSelectRico.iconSelect == 2 && Input.GetKeyDown(KeyCode.A) && BattleIconAttackSelectRico.hideButtons == false)
            {
