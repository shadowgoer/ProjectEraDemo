...
public class BattleIconItemSelectJoey : MonoBehaviour {
	...
	void Update () {
        ...
        else if (SpinnerControl.joeyTurn == true)
        {
            ...
            if (buttonSelected == false)
            {
                ...
                if (BattleIconAttackSelectJoey.iconSelect == 2)
                {
            ...
            //Selecting Button
            if (BattleIconAttackSelectJoey.iconSelect == 2 && Input.GetKeyDown(KeyCode.A) && BattleIconAttackSelectJoey.hideButtons == false)
            {
