...
public class BattleIconTacticsSelectTia : MonoBehaviour {
	...
	void Update () {
        ...
        if (SpinnerControl.tiaTurn == true)
        {
            ...
            if (buttonSelected == false)
            {
                ...
                if (BattleIconAttackSelectTia.iconSelect == 1)
                {
            ...
            //Selecting Button
            if (BattleIconAttackSelectTia.iconSelect == 1 && Input.GetKeyDown(KeyCode.A) && BattleIconAttackSelectTia.hideButtons == false)
            {
