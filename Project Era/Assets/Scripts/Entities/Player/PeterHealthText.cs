...
public class PeterHealthText : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            transform.position = Camera.main.ViewportToWorldPoint(new Vector3(-0.06f, 0.615f, 1));
            inBattle = true;
        ...
        this.gameObject.GetComponent<TextMesh>().text = ("HP: " + PeterStats.health + "/" + PeterStats.maxHealth + "\n" + "IP: " + PeterStats.IP + "/" + PeterStats.maxIP);
